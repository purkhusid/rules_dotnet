...
def emit_assembly_common(
    ...
    Args:
      ...
      version: the version of the generated assembly
    """
...
def _emit_assembly_common_fsharp(
        kind,
        dotnet,
        name,
        srcs,
    ...
    # select runner and action_args
    runner = dotnet.runner.files_to_run
    runner_tools = depset(transitive = [dotnet.runner.default_runfiles.files, dotnet.fsc.default_runfiles.files])
    action_args = [dotnet.fsc.files_to_run.executable.path, "@" + paramfile.path]
